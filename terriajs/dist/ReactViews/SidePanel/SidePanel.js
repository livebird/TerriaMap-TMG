...
const EmptyWorkbench = (props) => {
  ...
  return React.createElement(
    Text,
    { large: true, textLight: true },
    React.createElement(
      Box,
      { column: true, fullWidth: true, justifySpaceBetween: true },
      React.createElement(
        Box,
        { centered: true, column: true },
        React.createElement(ResponsiveSpacing, null),
        React.createElement(
          Text,
          { large: true, color: props.theme.textLightDimmed },
      ...
      React.createElement(
        BoxHelpfulHints,
        { column: true, paddedRatio: 3, overflowY: "auto", scroll: true },
        React.createElement(
          Box,
          { left: true },
          React.createElement(
            Text,
            { extraLarge: true, bold: true },
...
const SidePanel = observer(
  ({ viewState, theme, refForExploreMapData, refForUploadData }) => {
    ...
    return React.createElement(
      Box,
      { column: true, styledMinHeight: "0", flex: 1 },
      React.createElement(
        "div",
        {
          css: `
        ...
        React.createElement(SearchBoxAndResults, {
          viewState: viewState,
          terria: terria,
      ...
      React.createElement(
        ...
        terria.workbench.items && terria.workbench.items.length > 0
          ...
          : React.createElement(EmptyWorkbench, { theme: theme })
      )
    );
  }
);
