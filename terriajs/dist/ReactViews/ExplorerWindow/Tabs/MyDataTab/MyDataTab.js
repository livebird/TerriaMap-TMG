        ...
        return (React.createElement(Box, { className: Styles.root },
            React.createElement("div", { className: classNames({
                ...
                ` },
                        ...
                        t("addData.back")),
                    React.createElement(AddData, { terria: this.props.terria, viewState: this.props.viewState, activeTab: this.state.activeTab, resetTab: this.resetTab, onFileAddFinished: this.props.onFileAddFinished, localDataTypes: this.props.localDataTypes, remoteDataTypes: this.props.remoteDataTypes })),
