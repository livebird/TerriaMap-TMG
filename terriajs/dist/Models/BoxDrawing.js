...
export default class BoxDrawing {
    ...
    constructor(cesium, transform, options) {
        ...
        this.updateTerrainHeightEstimate = (() => {
            ...
            return async (forceUpdate = false) => {
                ...
                const boxCenter = Cartographic.fromCartesian(this.trs.translation, undefined, scratchBoxCenter);
                try {
    ...
    createSide(planeLocal) {
        ...
        const side = new Entity({
            ...
            plane: {
                ...
                outlineColor: new CallbackProperty(() => (isHighlighted
                    ...
                    : style.outlineColor).withAlpha(side.isFacingCamera ? 1 : 0.2), false),
                outlineWidth: 1
            }
        });
        ...
        const moveBoxOnDragSide = (mouseMove) => {
            ...
            if (moveUpDown) {
                ...
                const surfacePoint2d = scene.cartesianToCanvasCoordinates(surfacePoint, scratchSurfacePoint2d);
                if (!surfacePoint2d) {
                ...
                const previousPosition = screenToGlobePosition(scene, mouseMove.startPosition, scratchPreviousPosition);
                const endPosition = screenToGlobePosition(scene, mouseMove.endPosition, scratchEndPosition);
            ...
            this.updateBox();
            (_b = (_a = this.options).onChange) === null || _b === void 0 ? void 0 : _b.call(_a, {
                isFinished: false,
        ...
        const highlightAllSides = () => this.sides.forEach((side) => side.highlight());
    ...
    createScalePoint(pointLocal) {
        ...
        const cursorDirection = xDot === 1 || yDot === 1
            ? "ew-resize"
            : zDot === 1
                ? "ns-resize"
                : "nesw-resize";
...
BoxDrawing.localSidePlanes = SIDE_PLANES;
__decorate([
    observable
